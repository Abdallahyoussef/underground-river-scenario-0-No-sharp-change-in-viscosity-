...
K=[333*ones(((N-lx*6)/2),1); inf*ones(lx*6,1); 333*ones(((N-lx*6)/2),1)]; % horizontal permeability which is equal in x and y direction
...
%% ploting reservoir model and well locations
% figure(n+3)
% rock.perm =K(:);
% x=0:dx:dx*lx;   y=[0:256:3*256 832 848:4:880 896 960:256:1728];
% G = tensorGrid(x, y);
% plotCellData(G,rock.perm)
% hold on
% plot(45,850,'o');plot(4455,878,'*');